      ...
      <div class="panel-body">
        <table class="table table-hover" style="font-size:112%;">
			...
			<tbody>
                ...
                <tr>
                	<td><?php echo $item['DataTypeID']?></td>
                    <td><?php echo $item['Name']?></td>
                    <td style="width:400px;"><?php echo $item['Description']?></td>
                    <td><?php echo $item['Modifytime']?></td>
                    <td><?php echo $item['Modifyuser']?></td>
                    <td><a style="color:red;text-decoration:none;" href="<?=base_url()."index.php/listadmin/deletedatatype/".$item['DataTypeID']?>">&#10006;</a></td>
                </tr>
                <?php endforeach?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo form_open('listadmin/adddatatype')?>
          <div class="form-group">
            <label for="datatypename" class="control-label">資料類型名稱:</label>
            <input type="text" class="form-control" id="datatypename" name="datatypename">
